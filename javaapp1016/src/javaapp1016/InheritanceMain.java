...
class Derive extends Base{
	...
	@Override
	//상위 클래스에 disp()라는 메소드가 있는데 하위 클래스에서 다시 만드는 것을 Overriding이라 한다
	public void disp() {
...
public class InheritanceMain {
	...
	public static void main(String[] args) {
		...
		//Derive 클래스에는 disp()가 없지만 Base 클래스에 disp가 있고 Derive는
		...
		//에러 이유: 하위 클래스 타입의 변수에 상위 클래스 타입의 인스턴스는 대입 할 수 없다
		//해결 : 강제 형 변환을 이용해야만 한다
		derive = (Derive)base;
		
		//이 구문은 문법적인 에러는 없지만 실행하면 예외가 발생
